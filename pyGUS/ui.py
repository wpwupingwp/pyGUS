...
#    Jul 26, 2022 04:34:30 PM CST  platform: Darwin
...
class Root:
    def __init__(self, top=None):
        ...
        self.Button1.configure(command=ui_support.run_mode1)
        ...
        self.Button1_1.configure(command=ui_support.run_mode2)
        ...
        self.Button1_1_1.configure(command=ui_support.run_mode3)
        ...
        self.Button1_1_1_1.configure(command=ui_support.run_mode4)
        ...
        self.Button2.configure(command=ui_support.checker)
        ...
        self.b_help.configure(command=ui_support.help)
...
class root_mode1:
    def __init__(self, top=None):
        ...
        self.Button2.configure(activeforeground="#000000")
        self.Button2.configure(background="#edf0f3")
        self.Button2.configure(command=ui_support.run_mode1)
        self.Button2.configure(compound='left')
        self.Button2.configure(foreground="#000000")
        self.Button2.configure(highlightbackground="#edf0f3")
        self.Button2.configure(highlightcolor="black")
...
class root_mode2:
    def __init__(self, top=None):
        ...
        self.Entry1_1_1 = tk.Entry(self.Frame1_1_1_1)
        self.Entry1_1_1.place(relx=0.396, rely=0.125, height=30, relwidth=0.435)
        self.Entry1_1_1.configure(background="white")
        self.Entry1_1_1.configure(font="TkFixedFont")
        self.Entry1_1_1.configure(foreground="#000000")
        self.Entry1_1_1.configure(highlightbackground="#d9d9d9")
        ...
        self.Button2.configure(activeforeground="#000000")
        self.Button2.configure(background="#edf0f3")
        self.Button2.configure(command=ui_support.run_mode2)
        self.Button2.configure(compound='left')
        self.Button2.configure(foreground="#000000")
        self.Button2.configure(highlightbackground="#edf0f3")
        self.Button2.configure(highlightcolor="black")
...
class root_mode3:
    def __init__(self, top=None):
        ...
        self.Button2.configure(activeforeground="#000000")
        self.Button2.configure(background="#edf0f3")
        self.Button2.configure(command=ui_support.run_mode3)
        self.Button2.configure(compound='left')
        self.Button2.configure(foreground="#000000")
        self.Button2.configure(highlightbackground="#edf0f3")
        self.Button2.configure(highlightcolor="black")
